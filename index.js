...
// nestedFunction is a function that's nested within another function, it's demonstrating closure by accessing the variable internal because it is reaching out of it's local scope into the outer scope of another function to call the variable internal.
...
class CubeMaker extends CuboidMaker{
  ...
  surfaceArea(){
    return (this.length * this.length) + (this.length * this.length) + (this.length * this.length) + (this.length * this.length) + (this.length * this.length) + (this.length * this.length);
  }
}
